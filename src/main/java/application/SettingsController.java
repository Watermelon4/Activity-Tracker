...
//    ICommand contrastToggle = new ToggleContrastCommand(contrast);
//    ToggleableInvoker contrastCommands = new ToggleableInvoker(contrastToggle);
//
//    IToggleable nightMode = new ToggleNightCommand(false);
//    ICommand nightModeToggle = new ToggleContrastCommand(nightMode);
